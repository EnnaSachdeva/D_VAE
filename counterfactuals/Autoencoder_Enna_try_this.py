...
for epoch in range(num_epochs):
    ...
    epoch_training_loss = (running_training_loss_cumulative_for_epoch/len(training_states)).cpu()
    epoch_testing_loss = (running_testing_loss_cumulative_for_epoch/len(testing_states)).cpu()
    ...
    # # time.sleep(111)
    training_loss_list.append(epoch_training_loss.cpu())
    testing_loss_list.append(epoch_testing_loss.cpu())
